    ...
    <section class="container px-4 mx-auto">
        ...
        <div class="mt-6 md:flex md:items-center md:justify-between">
            <div class="inline-flex overflow-hidden bg-white border divide-x rounded-lg rtl:flex-row-reverse ">
                <button class="px-5 py-2 text-xs font-medium text-gray-600 transition-colors duration-200 sm:text-sm {{$type == 'all' ? 'bg-gray-100' : 'hover:bg-gray-300'}}" onclick="window.location.href='{{ url()->current() }}?type=all&statusType={{ $statusType }}'">
                    View all
                </button>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 ">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-4 text-sm whitespace-nowrap">
                                        <a href="{{ route('admin.verify', ['currentRoute' => 'applicants', 'applicantId' => $applicant->applicant_id, 'applicationType' => $applicant->applicationType]) }}" class="px-1 py-1 text-gray-500 transition-colors duration-200 rounded-lg hover:bg-gray-300 hover:rounded-full">
        ...
        <form action="{{ route('admin.generate.applicants', ['currentRoute' => $currentRoute]) }}" method="POST" target="__blank">
            @csrf
