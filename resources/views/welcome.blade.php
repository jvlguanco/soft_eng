...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <header class="flex h-20 px-3 bg-white border-b-2 border-yellow-400 border-solid">
            <div class="flex w-1/2 h-full">
                ...
                <div class="flex flex-col justify-center mx-3">
                    ...
                    <span class="text-gray-600 font-sans-serif">UNIVERSITY OF THE CITY OF MANILA</span>
                </div>
            </div>
        ...
        <footer class="flex flex-row gap-3 px-5 py-3 border-t-2 border-yellow-400 shadow-md h-96">
